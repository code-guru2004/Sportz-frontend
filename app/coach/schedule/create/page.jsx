// app/coach/schedule/create/page.jsx
"use client";
...
export default function CreateSchedulePage() {
  ...
  useEffect(() => {
    if (profile?.sport) {
      setFormData(prev => ({ ...prev, sport: profile.sport }));
    }
  }, [profile]);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="relative bg-[#0f0f12] border border-[rgba(212,175,100,0.15)] rounded-2xl shadow-2xl max-w-md w-full p-6 animate-slideDown">
            <div className="text-center">
              ...
              <h3 className="font-display text-xl font-medium text-[#f0e6c8] mb-2">Schedule Created!</h3>
              <p className="text-[rgba(240,230,200,0.6)] font-body text-sm">Your training schedule has been created successfully.</p>
      ...
      <div className="max-w-3xl mx-auto py-12 px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-[rgba(240,230,200,0.4)] font-body text-sm">
            Schedule a new training session for your athletes
          </p>
        </div>
